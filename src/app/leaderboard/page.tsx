...
export default function LeaderboardPage() {
    ...
    useEffect(() => {
        const fetchLeaderboard = async () => {
            ...
            try {
                ...
                // Handle both array and { leaderboard: [...] } response formats
    ...
    const currentUserRank = currentUserEntry && user ? leaderboard.findIndex(e => e.id === user.id) + 1 : null;
        ...
        return (
            <div className="container mx-auto px-4 py-8">
                <div className="text-center py-12">
                    <div className="spinner mx-auto mb-4 w-8 h-8 border-blue-600"></div>
